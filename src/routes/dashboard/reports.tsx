...
function ReportsPage() {
  const [reports, setReports] = useState<Report[]>([
    { id: 'RPT001', name: 'Monthly Performance Summary', type: 'Summary', date: '2026-01-01', status: 'Generated' },
    { id: 'RPT002', name: 'Q4 Analysis', type: 'Analytics', date: '2025-12-15', status: 'Generated' },
    { id: 'RPT003', name: 'User Engagement Metrics', type: 'Analytics', date: '2025-12-01', status: 'Processing' },
    { id: 'RPT004', name: 'Weekly Activity Log', type: 'Activity', date: '2026-01-20', status: 'Generated' },
  ])
    ...
    <DashboardLayout title="Reports">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Create and track operational reports in seconds.</p>
        </div>
              ...
              <tr key={report.id}>
                ...
                <td className="px-6 py-4 text-center">
                  {report.status === 'Generated' ? (
                    ...
                    <span className="text-red-600 text-sm flex items-center justify-center mx-auto gap-1">Failed</span>
                  )}
                </td>
              </tr>
            ))}
